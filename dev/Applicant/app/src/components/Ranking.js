    ...
    render() {
        ...
        return (
            <div style={{display: 'flex', flexDirection: 'row'}}>
                <Input name='rank' type='radio' value='1' label='Rank 1' className='with-gap'
                       onChange={this.handleRankingChange} checked={this.state.rank === 1}
                />
                &emsp;&emsp;&emsp;
                <Input name='rank' type='radio' value='2' label='Rank 2' className='with-gap'
                       onChange={this.handleRankingChange} checked={this.state.rank === 2}
                />
                &emsp;&emsp;&emsp;
                <Input name='rank' type='radio' value='3' label='Rank 3' className='with-gap'
                       onChange={this.handleRankingChange} checked={this.state.rank === 3}
                />
                &emsp;&emsp;&emsp;
                <Input name='rank' type='radio' value='4' label='Rank 4' className='with-gap'
